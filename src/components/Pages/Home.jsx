        ...
        <Flex w={"full"} gap={10} flexDir={{base: "column", lg: "row"}} zIndex={9}>
          ...
          <Box border={`1px solid ${borderColor}`} rounded={"xl"} p={5} w={{base: "90%", lg:"70%"}} mx={"auto"} h={"fit-content"} boxShadow={"-2px 8px 15px -5px rgba(0,0,0,0.5)"}>
            ...
            <UnorderedList fontSize={{lg: "md"}}>
              <ListItem w={{base: "90%", lg:"75%"}}>Menyelenggarakan berbagai kegiatan guna meningkatkan dan mengembangkan bakat, minat dan keterampilan prestasi siswa dari segi akademik maupun non akademik.</ListItem>
              <ListItem w={{base: "90%", lg:"75%"}}>Meneruskan dan Mengembangkan program kerja OSIS dan membangun lingkungan sekolah yang sehat dan bersih.</ListItem>
              <ListItem w={{base: "90%", lg:"75%"}}>Menyelenggarakan festival seni dan budaya, termasuk pameran karya siswa dan pentas seni.</ListItem>
              <ListItem w={{base: "90%", lg:"75%"}}>Memperkuat solidaritas dan kebersamaan antar siswa dengan menyelenggarakan acara peringatan hari besar nasional yang melibatkan partisipasi seluruh siswa.</ListItem>
              <ListItem w={{base: "90%", lg:"75%"}}>Mendukung kegiatan sosial dan kemanusiaan, mengorganisir kegiatan amal seperti bakti sosial.</ListItem>
              <ListItem w={{base: "90%", lg:"75%"}}>Berkomitmen untuk menjalin kerjasama yang baik dengan berbagai pihak, baik antar sekolah maupun dengan pihak luar, guna meningkatkan prestasi sesuai dengan perkembangan teknologi.</ListItem>
            </UnorderedList>
          </Box>
        </Flex>
      </Flex>
